                ...
                <Row className="aligh-items-center">
                    <Col xs={8} md={8} xl={8}>
                        <p>
                            ...
                            <br></br>
                            <br></br>
                            I am currently working as research assistant in Pervasive human computer Interaction Lab in Tsinghua University. I have earned a M.Eng. degree in Computer Science from
                            Tsinghua University in July 2024.
                            <br></br>
                            <br></br>
                            My research interest is to build systems that unobtrusively learn from the natural behavior, and then provide necessary interface adaptation. Specifically, Specifically,
                            user behavior in a given interaction context can implicitly reflect user’s intentions, strategies, preferences. Conversely, adjustments to the interaction context can
                            potentially impact user behavior.
                            <br></br>
                            <br></br>
